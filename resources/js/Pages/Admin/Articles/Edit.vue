...
const imagePreview = ref(props.article.image ? `/storage/${props.article.image}` : null);
...
const submit = () => {
    form.post(`/admin/articles/${props.article.id}`, {
        ...
        preserveScroll: true,
        onSuccess: () => {
            // Le formulaire sera mis à jour avec les nouvelles données
        },
    });
};
</script>
...
<template>
    <AppLayout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- En-tête -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier l'Article</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Mettez à jour votre article</p>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div v-if="imagePreview" class="mt-4">
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Aperçu :</p>
